...
public class CompiledLanguage
{
    ...
    public void GetCurrentFonts(out string regularFontUsed, out string tmpFontUsed)
    {
        ...
        regularFontUsed = I2LocManager.GetTermData(LocalizationPatcher.FontTermKey).Languages[_languageIndex];
        tmpFontUsed = I2LocManager.GetTermData(LocalizationPatcher.FontTmpTermKey).Languages[_languageIndex];
    }
